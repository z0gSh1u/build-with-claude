...
我们在 [01d.ipynb](https://github.com/z0gSh1u/build-with-claude/blob/master/main/01-accessing-claude/01d.ipynb) 中实现了这个逻辑。你可以看到 Claude 明白我们的第二个用户消息“写另一句话”是指扩展量子计算的定义，因为你提供了完整的对话上下文。
